...
import 'package:em_cartaz/app/widgets/classific/classific_cartaz_widget.dart';
import 'package:flutter/material.dart';

class CardCartazWidget extends StatelessWidget {
  const CardCartazWidget({
    Key? key,
    this.images,
    this.event,
  }) : super(key: key);
